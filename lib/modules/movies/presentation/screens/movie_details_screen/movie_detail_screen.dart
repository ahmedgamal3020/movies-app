...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MovieDetailsCubit>()..getMovieDetails(id: id)..getMovieRecommendations(id: id), 
                    ...
                    background: FadeIn(
                      ...
                      child: ShaderMask(
                        ...
                        CachedNetworkImage(
                          ...
                          imageUrl: ApiConstants.imageUrl( MovieDetailsCubit.get(context).movieDetailsModel!.backdropPath),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  MovieDetailsCubit.get(context).movieDetailsModel!.releaseDate.split('-')[0],
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    ( MovieDetailsCubit.get(context).movieDetailsModel!.voteAverage ).toStringAsFixed(1),
                                    style: const TextStyle(
                                      fontSize: 16.0,
                                      fontWeight: FontWeight.w500,
                                      letterSpacing: 1.2,
                              ...
                              Text(
                                _showDuration( MovieDetailsCubit.get(context).movieDetailsModel!.runTime),
                                style: const TextStyle(
                          ...
                          Text(
                            MovieDetailsCubit.get(context).movieDetailsModel!.overView,
                            style: const TextStyle(
                              fontSize: 14.0,
                          ...
                          Text(
                            'Genres: ${_showGenres( MovieDetailsCubit.get(context).movieDetailsModel!.genre)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
  ...
  builder: (context, state) {
    ...
    return SliverGrid(
      delegate: SliverChildBuilderDelegate(
        (context, index) {
          final recommendation = cubit.movieRecommendationsModel[index];
          return FadeInUp(
            from: 20,
            duration: const Duration(milliseconds: 500),
            child: ClipRRect(
